    ...
    public partial class InitialCreat2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestEngs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnsForTests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AnsForTests_TestEngs_IdTest",
                        column: x => x.IdTest,
                        principalTable: "TestEngs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_AnsForTests_IdTest",
                table: "AnsForTests",
                column: "IdTest");
        }
